...
\begin{figure}[htbp]
\begin{center}
\resizebox{14cm}{!}{\includegraphics{signature_counts.pdf}}
\end{center}
...
greater than $20$.
% FIXME Check this with the new code; size will be >= 24 then.
...
\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_4.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_6.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_7.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_8.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_9.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_10.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_11.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_12.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_13.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_14.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_15.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_16.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_17.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_18.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_19.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_20.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_21.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_22.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_23.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_24.pdf}}
\end{center}

\clearpage

The next plot shows the number of triangles with given side, across all $4 \leq n \leq 24$.

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_triangle_sizes_all.pdf}}
\end{center}
...
\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_4.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_6.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_7.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_8.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_9.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_10.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_11.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_12.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_13.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_14.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_15.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_16.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_17.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_18.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_19.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_20.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_21.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_22.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_23.pdf}}
\end{center}

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_24.pdf}}
\end{center}

\clearpage
The next plot shows the number of triangle elements with given side, across all $4 \leq n \leq 24$.

\begin{center}
\resizebox{12cm}{!}{\includegraphics{pp_element_sizes_all.pdf}}
\end{center}
...
\begin{center}
\includegraphics{largest_interior_n18_0.pdf}~\hspace{2cm}~\includegraphics{largest_interior_n18_1.pdf}
\end{center}

\begin{center}
\includegraphics{largest_interior_n18_2.pdf}~\hspace{2cm}~\includegraphics{largest_interior_n18_3.pdf}
\end{center}
...
\appendix*{Appendix A: Triangle dissections}
